    ...
    <>
      ...
      {showSettingsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div
            className="relative rounded-xl w-[530px] max-h-[90vh] shadow-xl overflow-hidden"
            style={{
              backgroundImage: `url(${popupBg})`, // Replace with your uploaded image path
              backgroundSize: "cover",
              backgroundPosition: "center",
            }}
          >
            {/* Top Heading with Cross Icon */}
            <div className="text-[#F4D98A] text-[24px] font-bold flex justify-between items-center px-6 pt-4">
              <span>Settings</span>
              <img
                src={close_icon}
                alt="close"
            ...
            <div className="mt-4 mx-4 bg-white bg-opacity-40 rounded-xl px-4 py-5 flex flex-col items-center gap-4">
              {/* Avatar */}
              <div className="relative w-20 h-20">
                ...
                {/* Overlay Image (e.g. pencil or badge) */}
                <img
                  src={ediatbel} // Replace with your actual icon
                  alt="edit badge"
              ...
              <div className="w-full flex flex-col gap-3">
                {/* Name with Edit */}
                <div className="flex justify-between items-center bg-[#E8BE5D] text-[#030303] text-[18px] font-medium px-4 py-3 rounded-lg shadow-[0px_4px_0px_#8C7338] cursor-pointer">
                ...
                <div
                  className="flex justify-between items-center bg-[#E8BE5D] text-[#030303] text-[18px] font-medium px-4 py-3 rounded-lg shadow-[0px_4px_0px_#8C7338] cursor-pointer"
                ...
                {/* Privacy policy */}
                <div
                  className="flex items-center gap-2 bg-[#E8BE5D] text-[#030303] text-[18px] font-medium px-4 py-3 rounded-lg shadow-[0px_4px_0px_#8C7338] cursor-pointer"
                ...
                {/* About us */}
                <div className="flex items-center gap-2 bg-[#E8BE5D] text-[#030303] text-[18px] font-medium px-4 py-3 rounded-lg shadow-[0px_4px_0px_#8C7338] cursor-pointer">
                ...
                {/* Logout */}
                <div className="flex items-center gap-2 bg-[#E8BE5D] text-[#030303] text-[18px] font-medium px-4 py-3 rounded-lg shadow-[0px_4px_0px_#8C7338] cursor-pointer"  onClick={() => setShowLogoutPopup(true)}>
      ...
      {showLogoutPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="w-[500px] bg-white rounded-xl p-6 shadow-lg relative">
            {/* Top row with delete icon and close icon */}
            <div className="flex justify-between items-center mb-4">
              <img src={logoutbtn} alt="delete"  />
              <button
      ...
      {showSubscriptionModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          >
            ...
            <div className="mt-4 mx-4 rounded-xl px-4 py-2 flex flex-col items-center gap-4 overflow-y-auto max-h-[calc(90vh-60px)] pb-6 scrollbar-hide">
              <img src={dimaond} alt="diamond" className="w-[80px] h-[80px]" />
              <h2 className="text-[#101828] text-[20px] font-semibold">
                Subscription plan
              </h2>
              <p className="text-[#373940] text-[17px] text-center">
              ...
              <div className="flex justify-between items-center w-full mt-2">
                ...
                <span className="text-[#295FB5] text-[15px] cursor-pointer">
                  Change plan
                </span>
              </div>
              ...
              <div className="w-full border border-[#357AE8] bg-[#EBF3FF] rounded-xl px-4 py-3 cursor-pointer">
                ...
                <ul className="mt-2 pl-6 list-disc text-[#344054] text-[14px] space-y-1">
                  <li>Unlimited access to all games</li>
                  <li>No daily limits</li>
                  <li>Monthly flexibility</li>
                </ul>

                <p className="mt-3 text-[14px] text-[#030303] font-semibold">
              ...
              <div className="w-full">
                <p className="mt-3 mb-2 text-[#101828] text-[16px] font-medium">
                  Other Plans
                </p>
              ...
              {/* Subscribe Button */}
              <button
                className="mt-4 bg-[#295FB5] text-white text-[16px] font-semibold py-2 px-6 rounded-lg cursor-pointer"
      ...
      {showConfirmPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl w-[500px] max-h-[90vh] overflow-y-auto p-6 shadow-xl scrollbar-hide">
            {/* Header */}
            <div className="text-[#101828] text-[20px] font-medium mb-4 flex justify-between items-center">
              <button
                onClick={() => {
                  setShowConfirmPopup(false);
                  setShowSubscriptionModal(true); // Optional: return to previous modal
                }}
              >
                ←
              </button>
            ...
            {/* Selected Plan Box */}
            <div className="border border-[#357AE8] bg-[#EBF3FF] rounded-xl p-4 flex justify-between items-start">
              <div>
                <label className="flex items-center gap-2">
                  <input
                    type="radio"
                    ...
                    className="accent-[#357AE8] w-4 h-4"
                  />
                  <span className="text-[#101828] text-[18px] font-medium">
                    Yearly Plan
                  </span>
                </label>
                <ul className="mt-2 pl-6 list-disc text-[#344054] text-[14px] space-y-1">
              ...
              <div className="text-right">
                <p className="text-[#101828] text-[16px] font-medium">
                  $39.99/year
                </p>
                <p className="text-[#9C27B0] text-[13px] font-semibold mt-1">
                  🌟 Best Value
                </p>
              </div>
            </div>
            ...
            {/* Details Section */}
            <div className="mt-6">
              <h3 className="text-[#101828] text-[26px] font-semibold mb-3">
                Details
              </h3>
              <div className="flex justify-between items-center text-[#101828] text-[20px] mb-2">
              ...
              <div className="flex justify-between items-center text-[#101828] text-[23px] font-semibold mt-4">
                <span>Total</span>
                <span>$41.58</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-[#101828] text-[26px] font-semibold">
                  Payment Method
                </h3>
                <button className="text-[#3A86FF] text-[15px] font-medium flex items-center gap-1">
                  <span className="text-[18px] font-bold">+</span> Add New
                </button>
              </div>

              {/* Mastercard */}
              <div className="border rounded-xl px-4 py-3 flex justify-between items-center mb-3 border-[#3A86FF]">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="text-[#101828] text-[20px] font-medium">
                      Mastercard
                    </p>
            ...
            {/* Pay Now Button */}
            <button
              className="mt-6 w-full bg-[#3A86FF] text-white text-[16px] font-semibold py-3 rounded-lg"
              onClick={() => {
                setShowConfirmPopup(false);
                setShowAddCardPopup(true); // 👈 Trigger Add Card popup
              }}
            >
              Pay Now
            </button>
      ...
      {showAddCardPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl w-[500px] p-6 shadow-xl max-h-[90vh] overflow-y-auto relative">
            {/* Close Button */}
            <button
            ...
            {/* Card Number */}
            <div className="mb-4">
              <label className="block text-[#344054] text-[16px] mb-1">
                Card number
              </label>
              <input
                type="text"
